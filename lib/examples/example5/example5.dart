...
class DataModel extends ChangeNotifier {
  ...
  UnmodifiableListView<Person> get pepole => UnmodifiableListView(_people);
...
final peropleProvider = ChangeNotifierProvider(
  (_) => DataModel(),
);
    ...
    return Scaffold(
      ...
      body: Consumer(
        builder: (context, ref, child) {
          final dataModel = ref.watch(peropleProvider);

          return ListView.builder(
            itemCount: dataModel.count,
            itemBuilder: (context, index) {
              final person = dataModel.pepole[index];
              return ListTile(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          if (person != null) {
            final DataModel dataModel = ref.read(peropleProvider);
